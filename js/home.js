// scroll reveal js
// Jumbotron
ScrollReveal().reveal('.jumbotron', {easing:"ease-out"});
ScrollReveal().reveal('#together', {delay:800, distance:"200px", easing:"ease-out", origin:"right"});
ScrollReveal().reveal('#lets', {delay:1400, distance:"200px", easing:"ease-out", origin:"right"});
ScrollReveal().reveal('#to', {delay:2800, distance:"200px", easing:"ease-out", origin:"right"});
ScrollReveal().reveal('#life', {delay:3500, distance:"200px", easing:"ease-out", origin:"right"});
